 ...
 * populating the HBase database with mock data.
 * Note: this class reads from two text files - Body and Emails and make sure HBase is running before calling main method
 * 
**/
